...
public class StoresAssertionTest {
    ...
    @Test
    public void test006() {
        String createdAt = response.extract().path("data[2].services[4].createdAt");
    ...
    public void test007() {
        ...
        System.out.println("The fourth state =  " + state);
    ...
    public void test008() {
        ...
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The store name of 9th store =  " + storeName);
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    @Test
    public void test009() {
        int storeId = response.extract().path("data[5].services[1].storeservices.storeId");

        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The storeId of 6th Store =  " + storeId);
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    public void test010() {
        ...
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The serviceId of 7th Store =  " + serviceId);
        System.out.println("------------------End of Test---------------------------");
